...
const posix_constants = @import("posix_constants");
const mem = std.mem;
const my_mem = @import("core/my_mem.zig");
const my_err = @import("core/my_err.zig"); // errors from zig/lib/std/posix.zig
const protocols = @import("core/protocols.zig"); // instead of constant structs from zig/lib/std/os/linux.zig
const net_err = @import("my_net_err.zig");
const my_posix = @import("core/my_posix.zig");
